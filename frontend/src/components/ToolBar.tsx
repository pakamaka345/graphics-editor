...
const ToolBar: React.FC<ToolBarProps> = ({ name, onBrushClick }) => {
    return (
        <div className="flex flex-col p-2">
            ...
            <div className="flex flex-col gap-3 p-2 bg-gray-900 rounded-lg shadow-lg">
                <button className="flex justify-center items-center text-xl bg-slate-600 rounded-lg p-3 hover:bg-slate-700 text-white transition-colors duration-300">
